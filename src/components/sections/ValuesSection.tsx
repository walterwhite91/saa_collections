...
export function ValuesSection() {
  ...
  return (
    <section className="py-24 bg-parchment border-y border-moss/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          {values.map((value, index) => (
            <motion.div
              ...
              className="flex flex-col items-center text-center group p-8 rounded-lg bg-linen/0 hover:bg-linen/50 hover:shadow-[0_15px_40px_rgba(142,119,86,0.08)] border border-transparent hover:border-umber/10 transition-all duration-500 cursor-pointer"
            >
